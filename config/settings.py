...
if not DEBUG:
    ...
    # HSTS forces browsers to use HTTPS. Off by default because it is unsafe to
    # hardcode on a shared subdomain (e.g. *.pythonanywhere.com); enable it on
    # your own domain via DJANGO_HSTS_SECONDS=31536000 (one year).
